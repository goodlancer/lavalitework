...
<div class="modal fade advance_search" id="modal-search">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#e2e2e2;color:#000;">
              ...
              ->action(guard_url('settings/settings'))!!}
                ...
                <div class="modal-footer">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <button class="btn theme-button pull-right " id="btn-apply-search" name="new" type="button" style="margin-left:5px;">
                            Search
                        </button>
                         <button aria-label="Close" class="btn pull-right theme-close-btn" data-dismiss="modal" type="button">
                            Close
                        </button>
                    </div>
                </div>
